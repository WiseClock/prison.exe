...
class HighScores {
    ...
    init() {
        /*inputHighScore(score: 10, name: "Player1")
        inputHighScore(score: 20, name: "Player2")
        inputHighScore(score: 30, name: "Player3")
        inputHighScore(score: 40, name: "Player4")
        inputHighScore(score: 50, name: "Player5")
        inputHighScore(score: 300, name: "Player6")
        inputHighScore(score: 88, name: "Player7")
        inputHighScore(score: 5, name: "Player8")
        inputHighScore(score: 45, name: "Player9")*/
        //printHighScores()
